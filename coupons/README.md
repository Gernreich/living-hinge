...
**`coupon-sheet-bridge-sweep-290x132mm.svg`** — all six on one 290 × 132mm sheet, one job.

Two groups:

| Group | Do this |
|---|---|
| `#cuts` | **Cut.** Hairline 0.02mm stroke, 756 paths |
...
**bridge increases left to right**, 1.0 → 2.5mm.
...
4. Take the narrowest bridge that survives cycling and **add 0.25mm** as your working value.
...
like *"1.0 and 1.25 snapped on the first bend, 1.5 held 30 cycles, 3mm birch ply, slits
