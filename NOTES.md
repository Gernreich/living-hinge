Three levels, most to least reliable.
  ...
  ▎ Use ~/LaserMadeMusic/GIT/living-hinge/living-hinge.js to make a chevron hinge 80 × 300 mm with a 10 mm margin.

  3. Just ask normally. In a session started in ~/Claude, this should be enough:

  ▎ Make me a living hinge, wave pattern, 80 × 300 mm.
